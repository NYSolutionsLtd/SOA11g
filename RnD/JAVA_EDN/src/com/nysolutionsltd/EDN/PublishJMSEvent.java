package com.nysolutionsltd.EDN;
...
public class PublishJMSEvent {
    ...
    public static void main(String[] args) {
        ...
        props.put(Context.PROVIDER_URL, "t3://dtlinux02.griffiths-waite.co.uk:8001");
        ...
        String EmployeeEventBody =
            "<Employee xmlns=\"http://com.nysolutionsltd.employee.event\">" +
            "<Id>Nitin"+ Math.random()+"</Id>" +
            "</Employee>";
